                ...
                <li key={address} className="col-span-1 flex flex-col text-center bg-white rounded-lg shadow">
                    ...
                    <div className="border-t border-gray-200">
                        <div className="-mt-px flex">
                            ...
                            <a href="#" onClick={async () => {await valist.revokeOrgAdmin(orgName, valist.defaultAccount, address)}} className="relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-4 text-sm leading-5 text-gray-700 font-medium border border-transparent rounded-bl-lg hover:text-gray-500 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 focus:z-10 transition ease-in-out duration-150">
