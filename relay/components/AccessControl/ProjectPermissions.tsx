        ...
        <div>
            <div className="col-span-3 sm:col-span-2 pb-8">
                <div className="mt-1 flex shadow-sm">
                    <input onChange={(e) => setGrantee(e.target.value)} value={grantee} required className="form-input flex-1 block rounded-l-md w-full rounded-none transition duration-150 ease-in-out sm:text-sm sm:leading-5" placeholder="0x0123456789012345678901234567890123456789" />
                    <div>
