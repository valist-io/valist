                ...
                <form className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    ...
                    <div className="col-span-12">
                        <span className="w-full inline-flex rounded-md shadow-sm">
                            <button onClick={async () => { setRenderLoading(true); await createOrganization(); setRenderLoading(false); }} value="Submit" type="button" className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 transition ease-in-out duration-150">
                                Create Organization
                            </button>
                        </span>
                    </div>
