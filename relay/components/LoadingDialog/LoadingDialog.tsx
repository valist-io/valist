...
export const LoadingDialog:FunctionComponent<any> = (props: any) => {
    return (
        <div className="fixed top-0 left-0 z-50 w-screen h-screen flex items-center justify-center" style={{background: "rgba(0, 0, 0, 0.3)"}}>
            <div className="bg-white border py-2 px-5 rounded-lg flex items-center flex-col" style={{ minHeight: "200px", minWidth: "250px" }}>
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{margin: "auto", display: "block"}} width="128px" height="128px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
