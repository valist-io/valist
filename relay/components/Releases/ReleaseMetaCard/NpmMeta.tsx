    ...
    return (
        <div>
            <div className="lg:w-80">
                ...
                <div ref={installRef} onClick={() => copyToCB(installRef)} className="border-2 border-solid border-black-200 rounded-lg p-2 bg-gray-200 cursor-pointer break-all mb-8">
                    npm install {origin}/api/{orgName}/{repoName}/latest
                </div>
                <div className="pb-2">
                    <h1 className="flex-1 text-lg leading-7 font-medium">Set Package Registry</h1>
                </div>
                <div ref={registryRef} onClick={() => copyToCB(registryRef)} className="border-2 border-solid border-black-200 rounded-lg h-auto p-2 bg-gray-200 cursor-pointer break-all mb-8">
