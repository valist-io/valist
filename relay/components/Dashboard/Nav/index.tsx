        ...
        <div className="relative flex flex-wrap items-center justify-center lg:justify-between">
          ...
          <div className="hidden lg:ml-4 lg:flex lg:items-center lg:py-5 lg:pr-0.5">
            ...
            <div className="ml-4 relative flex-shrink-0">
              <div>
                <button onClick={() => setMenuVisible(!menuVisible)} type="button" className="bg-white rounded-full flex text-sm ring-2 ring-white ring-opacity-20 focus:outline-none focus:ring-opacity-100" id="user-menu" aria-expanded="false" aria-haspopup="true">
                  <span className="sr-only">Open user menu</span>
                  <img className="h-8 w-8 rounded-full" src="https://avatars.githubusercontent.com/u/2301666?s=460&u=cca4bd9dc29b8cd726d53a17527e7eecb324ec69&v=4" alt="" />
                </button>
              </div>
