...
export const ProjectsList:FunctionComponent<any> = ({}) => {
    return (
            ...
            <li className="relative pl-4 pr-6 py-5 hover:bg-gray-50 sm:py-6 sm:pl-6 lg:pl-8 xl:pl-6">
                ...
                <div className="hidden sm:flex flex-col flex-shrink-0 items-end space-y-3">
                    ...
                    <button className="relative" type="button">
                        <svg className="h-5 w-5 text-yellow-300 hover:text-yellow-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
