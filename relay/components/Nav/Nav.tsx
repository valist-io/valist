                    ...
                    <div className="flex items-center justify-end">
                        <div className="flex">
                            ...
                            <a href="mailto:support@valist.io?subject=Valist Support" className="px-3 py-2 rounded-md text-sm leading-5 font-medium text-indigo-200 hover:text-white focus:outline-none focus:text-white focus:bg-indigo-600 transition duration-150 ease-in-out">Support</a>
                                {login.loggedIn ?
                                (<button onClick={() => login.logOut()} type="button" className="inline-flex ml-2 items-center px-6 py-1.5 border border-transparent text-xs font-medium rounded-full shadow-sm text-indigo-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Logout
                                </button>) :
