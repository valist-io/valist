...
const getValistOrganizationContract = (web3, address) => {
    // create the instance
    return getContractInstance(web3, ValistOrganization_json_1.default.abi, address);
};
const getValistRepositoryContract = (web3, address) => {
    // get network ID and the deployed address
    return getContractInstance(web3, ValistRepository_json_1.default.abi, address);
};
class Valist {
    ...
    getOrganization(orgName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const orgContract = yield this.valist.methods.orgs(orgName).call();
    ...
    getRepository(orgName, repoName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const org = yield this.getOrganization(orgName);
                const repoContract = yield org.methods.repos(repoName).call();
    ...
    getReposFromOrganization(orgName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const org = yield this.getOrganization(orgName);
                const repos = yield org.methods.getRepoNames().call();
                return repos;
            }
            catch (e) {
    ...
    getLatestTagFromRepo(orgName, repoName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const release = yield this.getLatestReleaseFromRepo(orgName, repoName);
                return release.tag;
            }
            catch (e) {
    ...
    getReleaseTagsFromRepo(orgName, repoName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const repo = yield this.getRepository(orgName, repoName);
                const tags = yield repo.methods.getTags().call();
                return [...tags].reverse();
            }
            catch (e) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                for (let i = 0; i < tags.length; i++) {
                    const release = yield repo.methods.releases(tags[i]).call();
    ...
    getReleaseByTag(orgName, repoName, tag) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const repo = yield this.getRepository(orgName, repoName);
                const release = yield repo.methods.releases(tag).call();
                return release;
            }
            catch (e) {
    ...
    createRepository(orgName, repoName, repoMeta, account) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const block = yield this.web3.eth.getBlock("latest");
                const result = yield org.methods.createRepository(repoName.toLowerCase().replace(exports.shortnameFilterRegex, ""), metaFile).send({ from: account, gasLimit: block.gasLimit });
                return result;
            }
            catch (e) {
    ...
    publishRelease(orgName, repoName, release, account) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const repo = yield this.getRepository(orgName, repoName);
                const block = yield this.web3.eth.getBlock("latest");
                const result = yield repo.methods.publishRelease(release.tag, release.hash, release.meta).send({ from: account, gasLimit: block.gasLimit });
                return result;
            }
            catch (e) {
