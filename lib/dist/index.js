...
class Valist {
    constructor({ web3Provider, metaTx = true, ipfsHost = `ipfs.infura.io` }) {
    ...
    grantOrgAdmin(orgName, granter, grantee) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.sendTransaction(this.valist.methods.grantOrgAdmin(orgName, grantee), granter);
            }
            catch (e) {
    ...
    revokeOrgAdmin(orgName, revoker, revokee) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.sendTransaction(this.valist.methods.revokeOrgAdmin(orgName, revokee), revoker);
            }
            catch (e) {
    ...
    grantRepoAdmin(orgName, repoName, granter, grantee) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.sendTransaction(this.valist.methods.grantRepoAdmin(orgName, repoName, grantee), granter);
            }
            catch (e) {
    ...
    revokeRepoAdmin(orgName, repoName, revoker, revokee) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.sendTransaction(this.valist.methods.revokeRepoAdmin(orgName, repoName, revokee), revoker);
            }
            catch (e) {
    ...
    grantRepoDev(orgName, repoName, granter, grantee) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.sendTransaction(this.valist.methods.grantRepoDev(orgName, repoName, grantee), granter);
            }
            catch (e) {
    ...
    revokeRepoDev(orgName, repoName, revoker, revokee) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.sendTransaction(this.valist.methods.revokeRepoDev(orgName, repoName, revokee), revoker);
            }
            catch (e) {
