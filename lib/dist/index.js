...
class Valist {
    ...
    grantOrgAdmin(orgName, account) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const org = yield this.getOrganization(orgName);
                yield org.methods.grantRole(ORG_ADMIN_ROLE, account).send({ from: account });
            }
            catch (e) {
    ...
    revokeOrgAdmin(orgName, account) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const org = yield this.getOrganization(orgName);
                yield org.methods.revokeRole(ORG_ADMIN_ROLE, account).send({ from: account });
            }
            catch (e) {
    ...
    grantRepoAdmin(orgName, repoName, account) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const repo = yield this.getRepository(orgName, repoName);
                return yield repo.methods.grantRole(REPO_ADMIN_ROLE, account).call();
            }
            catch (e) {
    ...
    revokeRepoAdmin(orgName, repoName, account) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const repo = yield this.getRepository(orgName, repoName);
                return yield repo.methods.revokeRole(REPO_ADMIN_ROLE, account).call();
            }
            catch (e) {
    ...
    grantRepoDev(orgName, repoName, account) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const repo = yield this.getRepository(orgName, repoName);
                return yield repo.methods.grantRole(REPO_DEV_ROLE, account).call();
            }
            catch (e) {
    ...
    revokeRepoDev(orgName, repoName, account) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const repo = yield this.getRepository(orgName, repoName);
                return yield repo.methods.revokeRole(REPO_DEV_ROLE, account).call();
            }
            catch (e) {
    ...
    createOrganization(orgName, orgMeta, account) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.valist.methods.createOrganization(orgName.toLowerCase(), metaFile).send({ from: account });
                return result;
            }
            catch (e) {
