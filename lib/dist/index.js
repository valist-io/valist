...
var Valist = /** @class */ (function () {
    ...
    Valist.prototype.getReleasesFromRepo = function (orgName, repoName, filter) {
        return __awaiter(this, void 0, void 0, function () {
            var repo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                return repo.events.Release({ filter: filter, fromBlock: 0 }).on('data', function (event) {
                                    var releases = event === null || event === void 0 ? void 0 : event.returnValues;
                                    if (releases) {
                                        resolve(releases);
                                    }
                                    else {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filter = { tag: tag };
                        return [4 /*yield*/, this.getReleasesFromRepo(orgName, repoName, filter)];
