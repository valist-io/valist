...
var Valist = /** @class */ (function () {
    ...
    Valist.prototype.getReleasesFromRepo = function (orgName, repoName) {
        return __awaiter(this, void 0, void 0, function () {
            var repo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        repo = _a.sent();
                        return [4 /*yield*/, repo.getPastEvents('Release', { fromBlock: 0, toBlock: 'latest' })];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    Valist.prototype.getReleaseByTag = function (orgName, repoName, tag) {
        return __awaiter(this, void 0, void 0, function () {
            var repo, events, i, _a, tag_1, release, releaseMeta;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getRepoFromOrganization(orgName, repoName)];
                    case 1:
                    ...
                    case 2:
                        ...
                        for (i = 0; i < events.length; i++) {
                            if (events[i].returnValues.tag == tag) {
                                _a = events[i].returnValues, tag_1 = _a.tag, release = _a.release, releaseMeta = _a.releaseMeta;
                                return [2 /*return*/, { tag: tag_1, release: release, releaseMeta: releaseMeta }];
                            }
                        }
                        return [2 /*return*/];
                }
