    ...
    createOrganization(orgName, orgMeta, account) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.valist.methods.createOrganization(orgName.toLowerCase().replace(exports.shortnameFilterRegex, ""), metaFile).send({ from: account });
                return result;
            }
            catch (e) {
    ...
    createRepository(orgName, repoName, repoMeta, account) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield org.methods.createRepository(repoName.toLowerCase().replace(exports.shortnameFilterRegex, ""), metaFile).send({ from: account });
                return result;
            }
            catch (e) {
