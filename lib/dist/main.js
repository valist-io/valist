...
var Valist = /** @class */ (function () {
    ...
    Valist.prototype.createOrganization = function (orgName, account) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.valist.methods.createOrganization(orgName).send({ from: account })];
                    case 1:
                        result = _a.sent();
